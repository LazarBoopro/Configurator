    ...
    const calculateTotalPrice = useCallback(
        (values: ValuesType) => {
            ...
            if (lastFieldLength <= 0.45) {
                decksTotal =
                    (fieldsCount - 1) * decksInFieldCount + Math.ceil(decksInFieldCount / 4);
            } else if (lastFieldLength <= 0.9) {
                decksTotal =
                    (fieldsCount - 1) * decksInFieldCount + Math.ceil(decksInFieldCount / 2);
            } else {
        ...
        <div className="form-main">
            ...
            <div className="form-main__row">
                ...
                <div className="row-items">
                    {woodTypes.map((type) => (
                        <div
                            key={type.name}
                            className={`color-cont ${values.wall === type.name ? "active" : ""}`}
                            onClick={() => {
            ...
            <div className="note">
                ...
                <Text color="primary">
                    ...
                    Deking Zona ograde obavezno je pripremiti betonsku osnovu (parapet) širine 20
                    cm.
                </Text>
            </div>
            ...
            <div className="info-wrapper">
                <Text variant="info">
                    ...
                    info@dekingzona.com. Konfigurator je informativnog karaktera.
                </Text>
            </div>
        </div>
    );
