  ...
  return (
    <div className="form-main">
      ...
      <div>
        <table className="table">
          <tbody className="body">
            ...
            <tr className="row">
              <td className="cell primary">Deking / ispuna</td>
              <td className="cell">
      ...
      <div className="note">
        ...
        <Text color="primary">
          Prikazani modeli na slikama mogu odstupati od izgleda proizvoda uživo,
          zbog različitih uslova osvetljenja, prikaza na ekranima i
          individualnih karakteristika materijala. Prikazana cena je bez
          uračunatog PDV-a, a trošak montaže je informativnog karaktera, bez
          uračunatih transportnih i terenskih troškova. Za instalaciju Deking
          Zona ograde obavezno je pripremiti betonsku osnovu (parapet) širine 20
          cm.
        </Text>
      </div>
      ...
      <div className="info-wrapper">
        <Text variant="info">
          ...
          upit na info@dekingzona.com. Konfigurator je informativnog karaktera.
        </Text>
      </div>
    </div>
  );
