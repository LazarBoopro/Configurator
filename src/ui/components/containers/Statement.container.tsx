    ...
    return (
        <div className="statement-main">
            ...
            <div className="note">
                ...
                <Text color="primary">
                    Prikazana cena je bez uračunatog PDV-a i bez uračunatih transportnih i terenskih
                    troškova. Za instalaciju Deking Zona ograde obavezno je pripremiti betonsku
                    osnovu (parapet) širine 20 cm.
                </Text>
            </div>
        </div>
    );
