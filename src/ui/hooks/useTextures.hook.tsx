...
export default function useTextures() {
  ...
  metal1Texture.normalMap.offset.set(
    metal1TextureOffset.x,
    metal1TextureOffset.y
  );
  metal1Texture.roughnessMap.offset.set(
    metal1TextureOffset.x,
    metal1TextureOffset.y
  );
  ...
  metal1Texture.normalMap.repeat.set(
    metal1TextureScale.x,
    metal1TextureScale.y
  );
  metal1Texture.roughnessMap.repeat.set(
    metal1TextureScale.x,
    metal1TextureScale.y
  );
  ...
  metal2Texture.normalMap.offset.set(
    metal2TextureOffset.x,
    metal2TextureOffset.y
  );
  metal2Texture.roughnessMap.offset.set(
    metal2TextureOffset.x,
    metal2TextureOffset.y
  );
  ...
  metal2Texture.normalMap.repeat.set(
    metal2TextureScale.x,
    metal2TextureScale.y
  );
  metal2Texture.roughnessMap.repeat.set(
    metal2TextureScale.x,
    metal2TextureScale.y
  );
  ...
  wood2Texture.roughnessMap.offset.set(
    wood2TextureOffset.x,
    wood2TextureOffset.y
  );
  ...
  const [selectedTexturePillar, setSelectedTexturePillar] =
    useState(metal1Texture);
